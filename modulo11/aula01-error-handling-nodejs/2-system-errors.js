...
//se o Promise.reject estiver dentro de um outro context,ele cai no unhandledRejection
setTimeout(async () => {
    await Promise.reject("promised async/await rejected!")
})

//mas se ele estiver no contexto globalm ele cai no uncaughtException
// await Promise.reject("promised async/await rejected!")
// uncaughtException
setTimeout(() => {
